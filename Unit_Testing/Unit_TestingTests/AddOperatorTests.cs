...
namespace Unit_Testing.Tests
{
    ...
    {
        public const double Tolerance = 0.0000001;//Here Tolerance means that we can handle this much margin for error.

        // To perform the addition of positive and negative numbers
        [TestMethod]
        ...
        public void Evaluate_AddPositiveNegativeArgs_ResultReturns((object[] operands, double expected) info)
        {
            ...
            //Act
            var addOperator = new Unit_Testing.AddOperator();
